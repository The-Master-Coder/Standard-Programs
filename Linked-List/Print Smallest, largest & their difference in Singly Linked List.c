...
{
	struct linkedlist *current, *prev, *nxt;
	current = start;
	prev = NULL;
	while (current != NULL) {
		nxt = current -> next;
...
int smallest(struct linkedlist* start)
{
	struct linkedlist * temp;
	temp = start;
	if (temp == NULL) {
...
int largest(struct linkedlist* start)
{
	struct linkedlist * temp;
	temp = start;
	if (temp == NULL) {
...
int difference(struct linkedlist* start)
{
	int s, l, d;
	s = smallest(start);
	l = largest(start);
...
int main()
{
	...
	while(1) {
		...
		printf("12. Print Smallest Element\n");
		printf("13. Print largest Element\n");
		printf("14. Print largest - smallest Element\n");
		printf("15. Exit\n");
