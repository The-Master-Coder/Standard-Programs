...
void BFS(struct bstnode *node,struct bstnode* queue[],int *front,int *rear,int *flag)
{
...
int main()
{
	...
	printf("\n");
	BFS(root,queue,&front,&rear,&flag);
	if (flag == 2) {
		printf("This BST is not Complete\n");
	} else {
		printf("This BST is Complete\n");
	}
	return 0;
